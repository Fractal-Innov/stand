...
Site statique d'une seule page (`index.html`, CSS et JS inclus dedans), déployé par GitHub Pages sur https://stand.fractal-innov.fr. La démo embarquée est servie depuis https://stand-demonstrateur.osc-fr1.scalingo.io/.
